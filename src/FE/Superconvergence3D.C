...
//  q1_ndof=q1_space->get_n_dof();  // not used in the rest of this function
  q1_values=q1_function->GetValues();
//  q2_ndof=q2_space->get_n_dof();  // not used in the rest of this function
  ...
  for(j=0;j<k;j++)
  {
    ...
    auto dof=q1_space->GetGlobalDOF(n0);
...
//  q2_ndof=q2_space->get_n_dof();  // not used in the rest of this function
  q2_values=q2_function->GetValues();
//  q3_ndof=q3_space->get_n_dof();  // not used in the rest of this function
...
//  q2_ndof=q2_space->get_n_dof();  // not used in the rest of this function
  q2_values=q2_function->GetValues();
//  q4_ndof=q4_space->get_n_dof();  // not used in the rest of this function
...
//  p1_ndof=p1_space->get_n_dof();  // not used in the rest of this function
  p1_values=p1_function->GetValues();
//  p2_ndof=p2_space->get_n_dof();  // not used in the rest of this function
  ...
  for(j=0;j<k;j++)
  {
    ...
    auto dof=p1_space->GetGlobalDOF(n0);
    for(l=0;l<4;l++)
      fine_values[l]=p1_values[dof[l]];

    dof=p1_space->GetGlobalDOF(n1);
    for(l=0;l<4;l++)
      fine_values[4+l]=p1_values[dof[l]];
 
    dof=p1_space->GetGlobalDOF(n2);
    for(l=0;l<4;l++)
      fine_values[8+l]=p1_values[dof[l]];
    
    dof=p1_space->GetGlobalDOF(n3);
    for(l=0;l<4;l++)
      fine_values[12+l]=p1_values[dof[l]];
 
    dof=p1_space->GetGlobalDOF(n4);
    for(l=0;l<4;l++)
      fine_values[16+l]=p1_values[dof[l]];

    dof=p1_space->GetGlobalDOF(n5);
    for(l=0;l<4;l++)
      fine_values[20+l]=p1_values[dof[l]];

    dof=p1_space->GetGlobalDOF(n6);
    for(l=0;l<4;l++)
      fine_values[24+l]=p1_values[dof[l]];

    dof=p1_space->GetGlobalDOF(n7);
    for(l=0;l<4;l++)
