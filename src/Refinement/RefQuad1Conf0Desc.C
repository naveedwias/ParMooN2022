// =======================================================================
// @(#)RefQuad1Conf0Desc.C        1.2 09/13/99
//
...
// Constructor
TRefQuad1Conf0Desc::TRefQuad1Conf0Desc(const TShapeDesc *shape) : TRefDesc(shape)
{
static const Shapes DatChildType[] = { Triangle, Triangle,
                                       Triangle };

static const Refinements DatEdgeType[] = { NoRef, NoRef, LineReg, NoRef};
...
static const int DatInteriorVertexOfEdge[][QUAD1ConfMAXN_iVpE] =
               { {-1}, {-1}, {4}, {-1}};
static const int DatInteriorVertexOfEdgeLen[] = { 0, 0, 1, 0};
...
static const int DatNewEdgeEqOldEdgeIndex[] = { 0, 1, 3};
