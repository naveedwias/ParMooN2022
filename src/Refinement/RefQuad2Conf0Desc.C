// =======================================================================
// @(#)RefQuad2Conf0Desc.C        1.2 09/13/99
//
...
// Constructor
TRefQuad2Conf0Desc::TRefQuad2Conf0Desc(const TShapeDesc *shape) : TRefDesc(shape)
{
static const Shapes DatChildType[] = { Quadrangle, Quadrangle,
                                       Quadrangle };

static const Refinements DatEdgeType[] = { LineReg, NoRef, NoRef, LineReg};
...
static const int DatInteriorVertexOfEdge[][QUAD2ConfMAXN_iVpE] =
               { {4}, {-1}, {-1}, {5}};
static const int DatInteriorVertexOfEdgeLen[] = { 1, 0, 0, 1};
