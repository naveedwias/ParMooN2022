// =======================================================================
// @(#)RefQuadBis0Desc.C        1.2 09/13/99
//
...
// Constructor
TRefQuadBis0Desc::TRefQuadBis0Desc(const TShapeDesc *shape) : TRefDesc(shape)
{
...
static const int DatNewVertexEqOldVertex[] = { 1, 3, 4, 0};
static const int DatNewVertexEqOldVertexIndex[] = { 0, 1, 2, 3};

static const int DatNewEdgeEqOldEdge[] = { 0, 3};
static const int DatNewEdgeEqOldEdgeIndex[] = { 3, 1};

static const int DatInteriorEdgeOfCell[] = { 6};

static const int DatInteriorVertexOfEdgeLen[] = { 1,  0,  1,  0};
