// =======================================================================
// @(#)RefQuad2Conf1Desc.C        1.2 09/13/99
//
...
// Constructor
TRefQuad2Conf1Desc::TRefQuad2Conf1Desc(const TShapeDesc *shape) : TRefDesc(shape)
{
static const Shapes DatChildType[] = { Quadrangle, Quadrangle,
                                       Quadrangle };

static const Refinements DatEdgeType[] = { LineReg, LineReg, NoRef, NoRef};
...
static const int DatInteriorVertexOfEdge[][QUAD2ConfMAXN_iVpE] =
               { {5}, {4}, {-1}, {-1}};
static const int DatInteriorVertexOfEdgeLen[] = { 1, 1, 0, 0};
...
static const int DatNewEdgeEqOldEdgeIndex[] = { 2, 3};
