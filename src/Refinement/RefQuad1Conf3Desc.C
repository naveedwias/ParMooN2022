// =======================================================================
// @(#)RefQuad1Conf3Desc.C        1.2 09/13/99
//
...
// Constructor
TRefQuad1Conf3Desc::TRefQuad1Conf3Desc(const TShapeDesc *shape) : TRefDesc(shape)
{
static const Shapes DatChildType[] = { Triangle, Triangle,
                                       Triangle };

static const Refinements DatEdgeType[] = { NoRef, LineReg, NoRef, NoRef};
...
static const int DatInteriorVertexOfEdge[][QUAD1ConfMAXN_iVpE] =
               { {-1}, {4}, {-1}, {-1}};
static const int DatInteriorVertexOfEdgeLen[] = { 0, 1, 0, 0};
...
static const int DatNewEdgeEqOldEdgeIndex[] = { 3, 0, 2};
