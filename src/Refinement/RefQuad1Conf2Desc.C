// =======================================================================
// @(#)RefQuad1Conf2Desc.C        1.2 09/13/99
//
...
// Constructor
TRefQuad1Conf2Desc::TRefQuad1Conf2Desc(const TShapeDesc *shape) : TRefDesc(shape)
{
static const Shapes DatChildType[] = { Triangle, Triangle,
                                       Triangle };

static const Refinements DatEdgeType[] = { LineReg, NoRef, NoRef, NoRef};
...
static const int DatInteriorVertexOfEdge[][QUAD1ConfMAXN_iVpE] =
               { {4}, {-1}, {-1}, {-1}};
static const int DatInteriorVertexOfEdgeLen[] = { 1, 0, 0, 0};
...
static const int DatNewEdgeEqOldEdgeIndex[] = { 2, 3, 1};
