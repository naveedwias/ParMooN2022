...
ParameterDatabase Example2D::default_example_database()
{
  ...
  db.add("degree_polynomial", 0u, "Parameter defining the maximal degree of the"
      " polynomial used in example Polynomial.h. Specify the degree with this "
      "parameter. In principle also degrees greater 50 would be possible. Since"
      " the computations then are very slow the degree is restricted to 50.",
      0u, 50u);

  db.add("is_RT_polynomial", false, "Parameter used in the NSE Example "
      "Polynomial.h. With this parameter it is specified whether the exact "
      "polynomial is a RT polynomial or a BDM, i.e. P_k polynomial. In case or "
      "a RT polynomial the parameter degree_polynomial corresponds with the "
      "order of RT functions, e.g. degree_polynomial = 0 is a polynomial of "
      "degree 1 and in RT0. ");
      
  db.add("pressure_factor", 1.0, "Parameter used in the NSE Examples Polynomial.h,"
  	  "SinCos.h and polynomial_solution.h to scale the pressure by a certain factor ");
  return db;
}
