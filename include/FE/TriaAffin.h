...
/** @brief affine reference transformation for triangles */
class TTriaAffin : public TRefTrans2D
{
  protected:
    ...
    /** @brief determinant of the derivative of the transformation */
    double detjk;

    /** @brief transformation matrix, needed to transform second derivatives */
    mutable double Eye[3][3];
