...
/** @brief isoparametric reference transformation for triangles
 * 
 * @todo implement transformation for second order derivatives
 * @todo document and test TTriaIsoparametric
 */
class TTriaIsoparametric : public TRefTrans2D
{
  protected:
    ...
    /** @brief base function type for each order of approximation */
    static BaseFunction_type BaseFunctFromOrder[]; 

    /** @brief base function type for each order of approximation */
    static FEDescriptor_type FEDescFromOrder[]; 
