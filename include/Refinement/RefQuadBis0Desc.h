// =======================================================================
// @(#)RefQuadBis0Desc.h        1.1 02/08/99
//
...
/** refinement descriptor for a bisection of a quadrangle based on edge 0 */
class TRefQuadBis0Desc : public TRefDesc
{
  public:
    // Constructor
    /** build a descriptor for bisection of a quadrangle */
    explicit TRefQuadBis0Desc(const TShapeDesc *shape);
