// =======================================================================
// @(#)RefTetraReg1Desc.h        1.2 10/18/99
//
...
#ifndef __REFTETRAREG1DESC__
#define __REFTETRAREG1DESC__
...
class TRefTetraReg1Desc : public TRefDesc
{
  public:
    // Constructor
    /** build a descriptor for a regular refinement of a tetrahedron */
    explicit TRefTetraReg1Desc(const TShapeDesc *shape);
