// =======================================================================
// @(#)RefQuad1Conf2Desc.h        1.1 08/26/99
//
...
#ifndef __REFQUAD1CONF2DESC__
#define __REFQUAD1CONF2DESC__
...
class TRefQuad1Conf2Desc : public TRefDesc
{
  public:
    // Constructor
    /** build a descriptor for conforming closure of a quadrangle */
    explicit TRefQuad1Conf2Desc(const TShapeDesc *shape);
