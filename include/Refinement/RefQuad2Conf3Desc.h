// =======================================================================
// @(#)RefQuad2Conf3Desc.h        1.1 08/26/99
//
...
#ifndef __REFQUAD2CONF3DESC__
#define __REFQUAD2CONF3DESC__
...
class TRefQuad2Conf3Desc : public TRefDesc
{
  public:
    // Constructor
    /** build a descriptor for conforming closure of a quadrangle */
    explicit TRefQuad2Conf3Desc(const TShapeDesc *shape);
