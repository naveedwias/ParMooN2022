// =======================================================================
// @(#)RefQuad2Conf1Desc.h        1.1 08/26/99
//
...
#ifndef __REFQUAD2CONF1DESC__
#define __REFQUAD2CONF1DESC__
...
class TRefQuad2Conf1Desc : public TRefDesc
{
  public:
    // Constructor
    /** build a descriptor for conforming closure of a quadrangle */
    explicit TRefQuad2Conf1Desc(const TShapeDesc *shape);
