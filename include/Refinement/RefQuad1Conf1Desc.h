// =======================================================================
// @(#)RefQuad1Conf1Desc.h        1.1 08/26/99
//
...
#ifndef __REFQUAD1CONF1DESC__
#define __REFQUAD1CONF1DESC__
...
class TRefQuad1Conf1Desc : public TRefDesc
{
  public:
    // Constructor
    /** build a descriptor for conforming closure of a quadrangle */
    explicit TRefQuad1Conf1Desc(const TShapeDesc *shape);
