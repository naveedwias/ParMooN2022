// =======================================================================
// @(#)RefQuad2Conf2Desc.h        1.1 08/26/99
//
...
#ifndef __REFQUAD2CONF2DESC__
#define __REFQUAD2CONF2DESC__
...
class TRefQuad2Conf2Desc : public TRefDesc
{
  public:
    // Constructor
    /** build a descriptor for conforming closure of a quadrangle */
    explicit TRefQuad2Conf2Desc(const TShapeDesc *shape);
