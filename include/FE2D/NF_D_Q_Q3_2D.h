...
static double *NF_D_Q_Q3_2D_T = nullptr;

void NF_D_Q_Q3_2D_EvalAll(const TCollection *, const TBaseCell *,
...
void NF_D_Q_Q3_2D_EvalEdge(const TCollection *, const TBaseCell *, int,
                           const double *, double *)
{
}
