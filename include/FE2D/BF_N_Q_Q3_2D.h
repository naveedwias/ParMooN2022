...
// note: this parameter used to be TDatabase::ParamDB->NC_TYPE, so it was
// possible to change it during run-time. I don't know what it is for.
constexpr int N_Q_Q3_2D_NC_TYPE = 3;
...
static void N_Q_Q3_2D_Funct(double xi, double eta, double *values)
{
  ...
  switch(N_Q_Q3_2D_NC_TYPE)
  {
    ...
    default:
      Output::print("unknown NC_TYPE: ", N_Q_Q3_2D_NC_TYPE);
  }
}
...
static int *N_Q_Q3_2D_Change1[4] = { N_Q_Q3_2D_ChangeJ0, N_Q_Q3_2D_ChangeJ1,
                                    N_Q_Q3_2D_ChangeJ2, N_Q_Q3_2D_ChangeJ3 };
static int **N_Q_Q3_2D_Change[] = { N_Q_Q3_2D_Change1 };
