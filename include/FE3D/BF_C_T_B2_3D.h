...
static void C_T_B2_3D_DeriveXiXi(double, double eta, double zeta,
                             double *values)
{
...
static void C_T_B2_3D_DeriveEtaEta(double xi, double, double zeta,
                             double *values)
{
 double t1 = 6.0*zeta;
 double t2 = 6.0*xi;
...
static void C_T_B2_3D_DeriveZetaZeta(double xi, double eta, double,
                             double *values)
{
