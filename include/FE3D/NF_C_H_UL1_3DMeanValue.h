...
void NF_C_H_UL1_3D_EvalAll(const TCollection *Coll, const TBaseCell *Cell,
                           const double *PointValues, double *Functionals)
{
  ...
  Functionals[8] = PointValues[8] + PointValues[9] + PointValues[10] + PointValues[11]
                   + PointValues[12] + PointValues[13] + PointValues[14] + PointValues[15];
  
}

void NF_C_H_UL1_3D_EvalFace(const TCollection *Coll, const TBaseCell *Cell, int Joint, 
                            const double *PointValues, double *Functionals)
{
  Functionals[0] = PointValues[0];
  Functionals[1] = PointValues[1];
...
TNodalFunctional3D *NF_C_H_UL1_3D_Obj = new TNodalFunctional3D
        (NF_C_H_UL1_3D, NF_C_H_UL1_3D_N_AllFunctionals,
         NF_C_H_UL1_3D_N_FaceFunctionals, NF_C_H_UL1_3D_N_PointsAll,
         NF_C_H_UL1_3D_N_PointsFace,
         NF_C_H_UL1_3D_Xi, NF_C_H_UL1_3D_Eta, NF_C_H_UL1_3D_Zeta,
         NF_C_H_UL1_3D_XiArray, NF_C_H_UL1_3D_EtaArray,
         NF_C_H_UL1_3D_ZetaArray,
         NF_C_H_UL1_3D_T, NF_C_H_UL1_3D_S,
         NF_C_H_UL1_3D_EvalAll, NF_C_H_UL1_3D_EvalFace);
