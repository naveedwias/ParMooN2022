...
static void D_H_Q2_3D_DeriveXiXi(double, double eta, double zeta,
                             double *values)
{
  values[0]  = 0;
...
static void D_H_Q2_3D_DeriveEtaEta(double xi, double, double zeta,
                             double *values)
{
  values[0]  = 0;
...
static void D_H_Q2_3D_DeriveZetaZeta(double xi, double eta, double,
                             double *values)
{
   values[0]  = 0;
