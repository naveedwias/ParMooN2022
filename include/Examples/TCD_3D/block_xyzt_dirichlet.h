...
{
  Output::print("Example: block_xyzt_dirichlet - solution x*y*z + t in domain of form of block 1x2x3 with Dirichlet boundary conditions");
}
...
double get_c_exact_solution_time_derivative_value(double , double , double , double )
{
  return 1.0;
}
...
void get_boundary_condition(int, double , double , double , BoundCond &cond)
{
  cond = DIRICHLET;
}
