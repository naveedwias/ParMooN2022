...
void ExampleFile()
{
  Output::print("Example: flow_around_cylinder_transient_inflow.h");
...
void U1BoundValue(int BdComp, double y, double &value)
{
  ...
  switch(BdComp)
  {
    ...
    case 2:
      ...
      break;
    case 3:
      value=std::sin(M_PI*t/8.)*6.*y*(1.-y);
      break;
    case 4:
       value = 0.;
       break;
...
void compute_drag_lift_pdiff(TimeNavierStokes<2>& time_nse2d, double&)
{
  ...
  Output::print(">>>>> Flow Around Cylinder (transient inflow) 2D: Postprocessing Output <<<<<");
