// ======================================================================
// Polynomial problem for the UnitSquare. This MAYBE works on other rectangles
// as well as long as the sides are ordered counterclockwise, the first side
// is parallel to the x-axis and below the third side.
// ======================================================================
                    ...
                    const double *const*, double **coeffs)
{
  ...
  {
    coeffs[i][0] = eps; // diffusion parameter
    coeffs[i][1] = 1; // parameters[i][0], 1st component of advection function b
    coeffs[i][2] = 2; // parameters[i][1], 2nd component of advection function b
    coeffs[i][3] = 3; // reaction function c
