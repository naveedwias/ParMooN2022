...
{
  Output::print("Example: rectangle_xyt_dirichlet - solution x*y*t with Dirichlet boundary conditions and domain 3x1");
}
...
void get_boundary_condition(int , double, BoundCond &cond)
{
    cond = DIRICHLET;
}
